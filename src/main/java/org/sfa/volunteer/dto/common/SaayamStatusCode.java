...
public enum SaayamStatusCode {
    ...
    IDENTITY_DOCUMENT_UPLOADED("SAAAYAM-1213"),
 // Client error codes (1300-1349)
    ...
    IDENTITY_DOCUMENT_NOT_FOUND("SAAAYAM-1314"),
    INVALID_DOCUMENT_SLOT("SAAAYAM-1315"),
    INVALID_DOCUMENT_TYPE("SAAAYAM-1316"),
    DOCUMENT_SIZE_EXCEEDED("SAAAYAM-1317"),
    DOCUMENT_NAME_REQUIRED("SAAAYAM-1318"),
    INVALID_DOCUMENT_EXPIRY("SAAAYAM-1319"),
    INVALID_DOCUMENT_FILE("SAAAYAM-1320"),
    ...
    DOCUMENT_STORAGE_ERROR("SAAAYAM-1355");
