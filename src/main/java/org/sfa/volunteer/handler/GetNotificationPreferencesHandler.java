...
public class GetNotificationPreferencesHandler
    ...
    public APIGatewayProxyResponseEvent handleRequest(APIGatewayProxyRequestEvent requestEvent, Context context) {
        ...
        try {
            ...
            GetNotificationPreferencesRequest request = objectMapper.convertValue(body, GetNotificationPreferencesRequest.class);

            GetNotificationPreferencesResponse result = notificationPreferenceService.getPreferences(request);

            SaayamResponse<GetNotificationPreferencesResponse> successResponse = responseBuilder.buildSuccessResponse(
